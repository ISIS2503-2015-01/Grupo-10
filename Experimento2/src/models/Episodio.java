...
public class Episodio 
{
  ...
  // Arreglo de Strings que indica los medicamentos  ingeridos por un paciente antes d eun episodiod e migraña
    ...
    public Episodio(String nDocPaciente, String fechaE,String nivelD,String horaE,String patronN,
    		ArrayList <String> alimentosN,ArrayList <String> bebidasN,ArrayList <String> actividadN,
    		ArrayList <String> medicamentoN, String nLocalizacion, String nNotasMed, String nPosCausas)
    {
        ...
        notasMedico = nNotasMed;
        posiblesCausas = nPosCausas;
    }
